...
int main(void) 
{
	...
	uint8 accelXdata; // variable for x-axis acceleration
	uint8 accelZdata; // variable for z-axis acceleration
	...
	*/
	...
	{	
		  accelXdata = getByteADXL(XDATA); // get x-axis acceleration
		  accelZdata = getByteADXL(ZDATA); // and the z-axis acceleration
		  // display the first acceleration value on the lower four digits
		  displayNumber((int8)accelXdata, 1); // casting to signed integer for displayNumber() function
		  delay(nLOOPS_per_DELAY); // small delay
		  // and now display the second acceleration value on the upper four digits
		  displayNumber((int8)accelZdata, 0); // casting to signed integer for displayNumber() function
		  delay(nLOOPS_per_DELAY); // small delay - most likely not needed
